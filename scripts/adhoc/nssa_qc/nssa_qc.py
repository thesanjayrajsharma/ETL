...
spreadsheet = client.open_by_url('https://docs.google.com/spreadsheets/d/1FaeIx_CQ-Y1p0vJ8GdtZnuQjWCtlhtclycaFzhxqsfs/edit?resourcekey=&gid=784856133#gid=784856133')

worksheet = spreadsheet.get_worksheet_by_id(784856133)
...
csv_file_path = r'/home/fevdevadmin/etl_repo/ETL/scripts/adhoc/NSSA_QC/nss_qc_data.csv'
